...
export const TEMPLATES: Template[] = [
  {
    ...
    durationSec: 30,
    summary:
      "Para los días previos a hablar en público. No va de perder el miedo: va de salir igualmente.",
    protocol:
      "Los 7 días antes de tu charla, nada más levantarte. El día de la charla, una vez más en el baño, justo antes de entrar.",
    affirmations: [
  ...
  },
  {
    ...
    title: "La conversación de sueldo",
    author: "Manifest",
    area: "carrera",
    style: "editorial",
    tone: "firme",
    ...
    durationSec: 30,
    summary:
      "Pedir lo que vales sin disculparte por pedirlo. Para la semana antes de sentarte a negociar.",
    protocol:
      "Una vez al día durante los 5 días previos. Escucha la frase, dila en alto, y luego di en alto la cifra que vas a pedir.",
    affirmations: [
  ...
  },
  {
    ...
    durationSec: 30,
    summary:
      "Empezar en un sitio nuevo sin sentirte un impostor. Para la noche antes y la mañana de.",
    protocol:
      "La noche anterior, antes de dormir. Y otra vez por la mañana, antes de salir de casa.",
    affirmations: [
  ...
  },
  {
    ...
    title: "Noventa días de constancia",
    author: "Manifest",
    area: "salud",
    style: "cinematic",
    tone: "firme",
    ...
    durationSec: 60,
    summary:
      "No va del físico, va de presentarte. Para quien empieza fuerte y abandona en la semana tres.",
    protocol:
      "Cada mañana antes de entrenar, los días que no tengas ganas especialmente. Ese es el día para el que está hecho.",
    affirmations: [
  ...
  },
  {
    ...
    title: "El mes que no llegó justo",
    author: "Manifest",
    area: "abundancia",
    style: "golden",
    tone: "calma",
    ...
    durationSec: 60,
    summary:
      "Para quien asocia el dinero con el estrés. No es hacerse rico: es dejar de mirar la cuenta con miedo.",
    protocol:
      "Cada noche antes de dormir, un mes entero. Funciona mejor de noche: es cuando aparece la ansiedad de dinero.",
    affirmations: [
  ...
  },
  {
    ...
    protocol:
      "Tres veces por semana, sin prisa. No lo uses justo después de una discusión: úsalo en días normales.",
    affirmations: [
  ...
  },
  {
    ...
    durationSec: 60,
    summary:
      "Montar algo tuyo y elegir con quién trabajas. Para la fase en la que todavía no te atreves a dejar el sueldo.",
    protocol:
      "Los domingos por la noche, que es cuando más pesa la semana que viene.",
    affirmations: [
  ...
  },
  {
    ...
    protocol:
      "Una vez al día durante el mes anterior a dar el paso. Después, cuando dudes.",
    affirmations: [
